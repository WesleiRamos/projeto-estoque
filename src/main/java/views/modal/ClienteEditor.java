...
public class ClienteEditor extends javax.swing.JDialog {
     ...
     * @param tituloModal 
     */
    public ClienteEditor(Store store, Actions action) {
        ...
        if (action == Actions.EDIT) {
            Cliente bean = getCurrentCliente();
            this.nome.setText(bean.getNome());
            this.cpf.setValue(bean.getCpf());
            this.email.setText(bean.getEmail());
            this.telefone.setText(bean.getTelefone());
        } else {
            this.cpf.setValue("000.000.000-00");
        }
        
        Masks.cpfMask(this.cpf);
    }
    ...
    private Cliente getCurrentCliente() {
        ...
        Cliente bean = (Cliente) store.get("selected");
        return bean == null ? new Cliente() : bean;
    }
    ...
    private Cliente getClienteDados() {
        ...
        bean.setCpf((String) this.cpf.getValue());
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(nome, javax.swing.GroupLayout.DEFAULT_SIZE, 457, Short.MAX_VALUE)
                    .addComponent(cpf)
                    .addComponent(email)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.store.set("edited", this.getClienteDados());
        this.close();
